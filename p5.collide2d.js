...
p5.prototype.collideLineCircle = function( x1,  y1,  x2,  y2,  cx,  cy,  diameter) {
  ...
  var inside1 = this.p5.prototype.collideLineLineVector = function(p1, p2, p3, p4, calcIntersection){
239
...
262
     top =    this.cop5.prototype.collideLineLineVector = function(p1, p2, p3, p4, calcIntersection){
239
  return p5.prototype.collideLineLine(p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, p4.x, p4.y, calcIntersection);
240
}
...
299
            collision = !collision;
300
    }llideLineLine(x1,y1,x2,y2, rx,ry, rx+rw,ry);
263
     bottom = this.collideLineLine(x1,y1,x2,y2, rx,ry+rh, rx+rw,ry+rh);
264
  }
...
299
            collision = !collision;
300
    }collidePointCircle(x1,y1, cx,cy,diameter);
